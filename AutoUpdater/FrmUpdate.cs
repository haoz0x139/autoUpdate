...
namespace AutoUpdater
{
    public partial class FrmUpdate : Form
    {
        ...
        bool isRun = false;
        string mainAppExe = "ZS.Main.NewPos";
        ...
        private void FrmUpdate_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                tempUpdatePath = Environment.GetEnvironmentVariable("Temp") + "\\" + "New_" + updaterXmlFiles.FindNode("//Application").Attributes["applicationId"].Value + "_" + "y" + "_" + "x" + "_" + "m" + "_" + "\\";
